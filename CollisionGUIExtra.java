 ...
 * @author Sanjana Goli and Rohith Mandavilli -- updated add method to handle additional blob types -- extra credit
 */
public class CollisionGUIExtra extends DrawingGUI {
	...
	private void add(int x, int y) {
		...
		else if (blobType=='u') { //Extra credit: Extend CollisionGUI to handle additional blob types - WanderingPulsar
	...
	private void findColliders() {
		// TODO: YOUR CODE HERE
				...
				PointQuadtreeExtra <Blob> tree = new PointQuadtreeExtra<Blob>(blobs.get(0), 0, 0, 800, 600);
				for(Blob b: blobs)
					tree.insert(b);

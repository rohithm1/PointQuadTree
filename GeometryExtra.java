 ...
 * @author Sanjana Goli and Rohith Mandavilli - added pointInRectangle method
 */
public class GeometryExtra {
	...
	//EXTRA CREDIT
	//added pointInRectangle to geometry class to check if a point is in the rectangle when the rectangle is dragged
	public static boolean pointInRectangle(double x, double y, double cx, double cy, int width, int height)
	{
		if(cx>x && cx< x+ width)
			if(cy>y && cy< y+height)
				return true;
